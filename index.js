...
const config = {
    ...
    nomer: 'wa.me/6281260899819',
    aktif: '24 JAM (Kalo Di Hidupin Xixi',
    youtube: 'https://youtube.com/c/X-MrG3P5',
    whatsapp: 'https://chat.whatsapp.com/L5MJHVMsBcL56CdoKoFfkJ',
...
client.on('qr', qr => {
   ...
   console.log(`[ ${time} ] QR code is ready, subscribe Mamank X-MrG3P5 ID`)
})
...
client.on('message-status-update', json => {
   ...
   console.log(`[ ${time} ] => bot by ig:@ini.pff`)
})
       ...
       case 'igstalk':
           igStalk(value)
               .then(data => {
                   ...
                   let hasil = `Biodata Instagram _${value}_ \n\n 🧶 *Username* : ${Username}_ \n  *Nama* : _${Name}_ \n  *Pengikut* : _${Jumlah_Followers}_ \n  *Mengikuti* : _${Jumlah_Following}_ \n  *Jumlah_Postingan* : _${Jumlah_Post}_ \n *Terverifikasi* : _${Verification}_ \n *Private : _${Private}_`
                   client.sendMessage(id, hasil, MessageType.text)
               })
               .catch(err => {
   ...
   case 'bitly':
    ...
    case 'bucin':
     ...
     case 'cooltext':
           ...
           break
          case 'creator':
            client.sendContact(from, '6281260899819@c.us')
            break
      case 'tts':
